...
daily["ma30"] = (
    trading_day_rolling_mean(
        daily,
        "close",
        window_days=ma_trend_window,
        min_history_days=ma_trend_window,
    )
)
daily["ma60"] = (
    trading_day_rolling_mean(
        daily,
        "close",
        window_days=ma_slow_window,
        min_history_days=ma_slow_window,
    )
)
...
daily["ma30_ma60_filter"] = daily["ma30"] > daily["ma60"]
